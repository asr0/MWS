    ...
    public static class ProdutoScope
    {
        public static bool RegistrarProdutoValido(this Produto produto)
        {
            return AssertionConcern.IsSatisfiedBy(
                ...
                AssertionConcern.AssertIsGreaterOrEqualThan(produto.Preco, 0, "O preço do produto não pode ser menor que zero"),
        ...
        public static bool AtualizarInformacoesValido(this Produto produto, string titulo, string descricao, int categoria)
        {
            return AssertionConcern.IsSatisfiedBy(
