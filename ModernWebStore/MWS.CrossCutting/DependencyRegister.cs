...
namespace MWS.CrossCutting
{
    public class DependencyRegister
    {
        public static void Register(UnityContainer container)
        {
            ...
            container.RegisterType<IUsuarioApplicationService, UsuarioApplicationService>(
                new HierarchicalLifetimeManager());
            container.RegisterType<ICategoriaApplicationService, CategoriaApplicationService>(
                new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IHandler<NotificacaoDominio>, NotificacaoDominioHandler>(
                new HierarchicalLifetimeManager());
        }
    }
}